...
async function abrirModalEditarProducto(productoId) {
    try {
        ...
        document.getElementById('editStock').value = (parseInt(producto.stock_bodega) || 0) + (parseInt(producto.stock_tienda) || 0);
...
async function guardarEdicionProducto() {
    ...
    const payload = {
        ...
        stock_bodega: parseInt(document.getElementById('editStock').value) || 0
    };
